...
import { FaAward, FaCalendar, FaCalendarAlt, FaGlobeAfrica, FaLeaf, FaSolarPanel, FaTrophy } from "react-icons/fa";
import { FaEarthAfrica, FaHouse, FaPeopleGroup } from "react-icons/fa6";
...
export default function Page() {
    ...
    function animatePrix() {

    }

    function animateAnnee() {

    }

    function animatePays() {
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="p-8 rounded-xl shadow hover:shadow-xl hover:bg-blue-50 bg-red-50 grid grid-cols-1 gap-4">
                            ...
                            <div>
                                <p onScroll={animatePrix} className="text-center text-6xl font-bold text-green-600">{prix}</p>
                            </div>
                            <div>
                        ...
                        <div className="p-8 rounded-xl shadow hover:shadow-xl hover:bg-blue-50 bg-red-50 grid grid-cols-1 gap-4">
                            ...
                            <div>
                                <p onScroll={animateAnnee} className="text-center text-6xl font-bold text-green-600">{annee}</p>
                            </div>
                            <div>
                        ...
                        <div className="p-8 rounded-xl shadow hover:shadow-xl hover:bg-blue-50 bg-red-50 grid grid-cols-1 gap-4">
                            ...
                            <div>
                                <p onScroll={animatePays} className="text-center text-6xl font-bold text-green-600">{pays}</p>
                            </div>
                            <div>
                        ...
                        <div className="p-8 rounded-xl shadow hover:shadow-xl hover:bg-blue-50 bg-red-50 grid grid-cols-1 gap-4">
                            ...
                            <div>
                                <p onScroll={animateSatisfaction} className="text-center text-6xl font-bold text-green-600">{satisfaction}</p>
                            </div>
                            <div>
